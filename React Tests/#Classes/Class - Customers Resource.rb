class CustomersResource
  ...
  DETAIL_ACTIONS_MENU = {css: "div[id='b56-b12-b60-b1-DropdownHeader']"}
    DETAIL_CREATE_ACTIVITY = {css: "span[id='b56-b12-b60-GridActionsCreateActivity']"}
  ...
  def delete_top_contact()
    ...
    option.click
    sleep(1)
    wait.until {@driver.find_element(TOP_CONTACT_DELETE_CONFIRM).displayed?}
    confirm = @driver.find_element(TOP_CONTACT_DELETE_CONFIRM)
    confirm.click
    sleep(1)
  end
